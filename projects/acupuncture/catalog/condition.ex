defmodule Acupuncture.Catalog.Condition do
  @moduledoc """
  A Condition — an acupuncture-site content type (migrated from Sanity). All of
  its behaviour (block editor, publishing workflow, version history, search,
