...
| Variable | Default | Purpose | Where it's read |
|----------|---------|---------|-----------------|
| `ADMIN_EMAIL` | `admin@kiln.test` | Email of the admin user created by `mix run priv/repo/seeds.exs`. | [`priv/repo/seeds.exs:58`](../priv/repo/seeds.exs#L58) |
| `ADMIN_PASSWORD` | `kilnadmin123` | That user's password. **The default is a published credential** — override it for anything reachable from a network. | [`priv/repo/seeds.exs:59`](../priv/repo/seeds.exs#L59) |
| `EDITOR_EMAIL` | `editor@kiln.test` | Email of the seeded editor user. | [`priv/repo/seeds.exs:60`](../priv/repo/seeds.exs#L60) |
| `EDITOR_PASSWORD` | `kilneditor123` | That user's password; same caveat as `ADMIN_PASSWORD`. | [`priv/repo/seeds.exs:61`](../priv/repo/seeds.exs#L61) |
