# KilnCMS 0.5.0 — full release notes

The long-form entries behind the 0.5.0 section of
...
<a id="the-occurrence-backfill-runs-itself-766-no-step-to-perform-but-worth-knowing-it"></a>
...
<a id="rolling-back-past-the-history-anchor-sequence-migration-is-a-one-way-door-for"></a>
...
<a id="it-will-not-stop-your-deployment-coming-up"></a>
...
<a id="rolling-the-release-back-is-not-symmetric"></a>
...
<a id="integer-valued-variables-are-now-bounded-at-2³¹-1-1091-which-affects"></a>
...
<a id="post-apiauthsignin-can-now-answer-200-instead-of-201-and-any-client-that"></a>
...
<a id="everyone-is-signed-out-once-on-deploy"></a>
...
<a id="set-embedorigins-before-deploying-if-you-embed-forms-on-other-sites"></a>
...
<a id="overlays-that-call-kilncmswebtenantcurrentorgid1-or-currentorg1-outside-a"></a>
...
<a id="check-databasessl-before-deploying-if-you-set-it-at-all"></a>
...
<a id="check-phxserver-too-if-you-set-it-to-something-false-looking"></a>
...
<a id="a-white-labelled-site-installs-under-its-own-icon-and-its-offline-page-carries"></a>
...
<a id="the-governance-dashboard-says-whether-history-is-actually-being-witnessed"></a>
...
<a id="xliff-20-exportimport-for-translation-vendors"></a>
...
- **XLIFF 2.0 export/import for translation vendors** (#502). `/editor/translations`
  ...
  See [docs/localization-workflows.md](../localization-workflows.md).
...
<a id="events-whats-on-soonest-first"></a>

- **Events: "what's on, soonest first"**. The reasoning behind it is recorded as
  a decision in
  [docs/decisions/0009-events-are-a-shape-content-can-take-not-a-resource-of-their-own.md](../../docs/decisions/0009-events-are-a-shape-content-can-take-not-a-resource-of-their-own.md).

<a id="feed-syndication-is-a-per-site-setting"></a>
...
<a id="content-experiments-ab-testing-published-content-499-phase-1"></a>
...
- **Content experiments — A/B testing published content** (#499, phase 1).
  ...
  and rationale in [docs/content-experiments-plan.md](../content-experiments-plan.md).
...
<a id="activitypub-federation-a-kiln-site-as-a-fediverse-actor-491-phase-1"></a>
...
- **ActivityPub federation: a Kiln site as a fediverse actor** (#491, phase 1).
  ...
  and prints the handle; see [docs/federation.md](../federation.md).
...
<a id="reusable-content-fragments"></a>
...
- **Reusable content fragments.** A `fragment` block embeds another document's
  ...
  [Extending the content model](../extending-content.md).

<a id="json-schema-typescript-export-of-block-definitions"></a>
...
- **JSON Schema / TypeScript export of block definitions.** The last unshipped
  ...
  document at `/api/json/open_api`. See [§ Schema discovery](../api.md#schema-discovery-typed-clients).
...
<a id="bulk-content-importexport-and-a-wordpress-wxr-importer"></a>
...
<a id="kilncmsblockshtml-reads-legacy-html-back-into-portable-text-and-typed-blocks"></a>
...
<a id="a-translation-now-keeps-the-sources-block-ids"></a>
...
<a id="the-media-ingest-pipeline-is-one-module"></a>
...
<a id="webpavif-variants-quality-settings-and-bulk-regeneration"></a>
...
<a id="editor-managed-navigation-menus"></a>
...
- **Editor-managed navigation menus.** `/editor/menus` builds ordered trees of
  ...
  [Navigation menus](../navigation-menus.md).

## Fixed

<a id="a-field-granted-editor-is-no-longer-offered-a-billed-ai-run-the-save-will-refuse"></a>
...
<a id="the-editors-tag-picker-no-longer-detaches-tags-it-never-showed-you"></a>
...
<a id="a-navigation-subtree-that-goes-missing-can-be-got-back"></a>
...
<a id="changing-a-nested-headings-level-in-a-columns-block-now-takes-effect"></a>
...
<a id="the-collab-editor-flake-is-checked-for-not-just-fixed"></a>
...
<a id="referrer-suppression-now-actually-suppresses"></a>
...
<a id="turning-off-full-content-feeds-now-empties-the-cached-feed-bodies-on-every-node"></a>
...
<a id="the-tag-suggestion-threshold-is-measured-now-and-the-old-one-was-inert"></a>
...
<a id="a-content-types-default-seo-description-now-reaches-every-surface-that-renders"></a>
...
- **A content type's default SEO description now reaches every surface that
  ...
  than widening that select. See [docs/seo.md](../seo.md).

<a id="the-form-builder-showed-value-instead-of-the-value-it-was-refusing"></a>
...
<a id="the-embed-page-now-sends-vary-accept-language"></a>
...
<a id="two-separators-in-the-form-builder-rendered-as-nothing"></a>
...
<a id="the-sitemap-escaped-three-characters-where-the-feeds-escaped-five"></a>
...
<a id="a-headless-two-factor-pending-token-is-now-single-use-exactly-not-best-effort"></a>
...
<a id="a-client-chosen-payload-shape-no-longer-crashes-any-editor-liveview-764"></a>
...
<a id="the-site-name-rendered-twice-in-the-browser-tab"></a>
...
<a id="safehref1-accepted-evilcom"></a>
...
<a id="404-capture-paired-with-redirects"></a>
...
- **404 capture, paired with redirects.** `/editor/redirects` grows a **404s**
  ...
  table; see [Data flows](../data-flows.md).

<a id="the-editor-pwas-web-app-manifest-is-localized"></a>
...
<a id="auto-complete-on-publish-is-now-configurable"></a>
...
<a id="mix-kilnauditcheckpoint---audit-walks-the-checkpoint-runs-predecessor-links-and"></a>
...
<a id="editorial-claim-checking"></a>
...
- **Editorial claim checking.** A **Compliance** panel in the content editor
  ...
  [Editorial claim checking](../compliance.md).
...
<a id="beta-testing-program"></a>

- **Beta testing program.** [Beta user testing](../beta-testing.md) documents
...
<a id="add-to-release-from-the-content-editor"></a>
...
<a id="content-releases-are-bounded"></a>
...
<a id="content-releases-bundled-atomically-published-groups-of-changes"></a>
...
- **Content releases: bundled, atomically published groups of changes.** A
  ...
  [Content releases](../content-releases.md).
...
<a id="event-content-schedules-recurrence-and-calendar-output"></a>
...
- **Event content: schedules, recurrence, and calendar output.** Kiln has no
  ...
  index. See [events.md](../events.md).

<a id="rich-embed-cards-server-side-oembed-metadata"></a>

- **Rich embed cards: server-side oEmbed metadata.** The reasoning behind it is
  recorded as a decision in
  [docs/decisions/0010-embed-metadata-is-resolved-server-side-against-a-curated-provider-list.md](../../docs/decisions/0010-embed-metadata-is-resolved-server-side-against-a-curated-provider-list.md).

<a id="broken-outbound-links-a-scheduled-sweep-and-a-site-wide-report-the-other-half"></a>
...
- **Broken outbound links: a scheduled sweep and a site-wide report** — the
  ...
  **`KilnCMS.SafeFetch` gained `head/2` and `:max_redirects`.** Following a
  ...
  network, nightly. See [`docs/link-checking.md`](../link-checking.md).

<a id="broken-internal-links-are-flagged-in-the-editor-the-deterministic-half-of-the"></a>
...
<a id="a-gallery-block-and-an-accordion-block-that-deliberately-fires-no-structured"></a>
...
<a id="readingtimeminutes-alongside-wordcount-on-every-content-type-in-the-same-places"></a>
...
<a id="wordcount-now-counts-unicode-whitespace-fixing-a-disagreement-the-new-reading"></a>
...
<a id="the-readingtime-computed-field-function-now-uses-the-same-configured-rate-as"></a>
...
<a id="a-manual-delivery-cache-purge"></a>
...
<a id="a-deployment-behind-a-proxy-with-trustedproxies-unset-now-says-so"></a>
...
<a id="tenantstricthosttrue-rejects-a-request-whose-host-matches-no-organization"></a>
...
<a id="content-updates-take-addtagids-and-removetagids-alongside-the-existing-tagids"></a>
...
<a id="mix-docs-now-builds-a-complete-manual-the-api-reference-for-every-module-in-lib"></a>
...
<a id="content-analytics-now-keeps-a-daily-view-bucket-alongside-the-all-time-counter"></a>
...
<a id="recording-a-content-view-now-emits-a-kilncms-analytics-view-telemetry-event"></a>
...
<a id="kilnversion-a-running-instance-can-now-report-its-release-version-and-the-git"></a>
...
<a id="mix-kilnupdate-moves-a-downstream-projects-pinned-kiln-checkout-submodule-or"></a>
...
<a id="an-admin-only-update-notice-showing-the-running-version-against-the-latest"></a>
...
<a id="tool-versions-is-now-the-single-source-of-truth-for-the-elixirotp-toolchain"></a>
...
<a id="the-update-check-is-no-longer-nailed-to-this-repo"></a>
...
<a id="media-stored-on-s3minio-is-now-uploaded-with-cache-control-public-max"></a>
...
<a id="media-stored-on-s3minio-is-now-uploaded-with-content-disposition-attachment"></a>
...
<a id="the-remaining-auth-pages-no-longer-render-another-tenants-branding"></a>
...
<a id="a-client-chosen-payload-shape-no-longer-crashes-an-editor-liveview"></a>
...
<a id="kilnstricttesttrue-ran-the-test-suite-without-strict-tenancy-and-said-nothing"></a>
...
<a id="every-configruntimeexs-line-anchor-in-docsenvironment-variablesmd-points-at-the"></a>
...
<a id="a-rate-limited-request-now-answers-the-same-error-envelope-as-everything-else"></a>
...
<a id="auditanchoreverywrite-no-longer-reports-untouched-documents-as-tampered"></a>
...
<a id="the-collaborative-editing-doc-supervisor-is-bounded"></a>
...
<a id="entriesversions-had-no-index-on-versionsourceid"></a>
...
<a id="history-anchoring-no-longer-resumes-its-incremental-fold-with-a-sql-offset"></a>
...
<a id="artifacts-fired-before-a-surface-shape-change-are-now-migrated-instead-of"></a>
...
<a id="kilncmswebtenantcurrentorgid1-raises-on-a-missing-currentorg-assign-instead-of"></a>
...
<a id="databasessltrue-no-longer-disables-postgres-tls"></a>
...
<a id="every-onoff-environment-variable-now-goes-through-one-parser-kilncmsconfigenv"></a>
...
<a id="phxserverfalse-no-longer-starts-the-web-server"></a>
...
<a id="a-blank-databasesslcacertfile-configured-verifypeer-against-an-empty-path-so"></a>
...
<a id="kilnstagingforce-accepted-only-the-literal-1-so-kilnstagingforcetrue-read-as"></a>
...
<a id="the-media-librarys-responsive-variant-list-previews-each-variant-inline-instead"></a>
...
<a id="promoting-a-dynamic-type-no-longer-leaves-its-documents-unwitnessed-for-a"></a>
...
<a id="a-forms-embed-allowlist-is-now-the-forms-not-the-deployments"></a>

- **A form's embed allowlist is now the form's, not the deployment's**. The
  reasoning behind it is recorded as a decision in
  [docs/decisions/0006-a-forms-embed-allowlist-belongs-to-the-form-not-to-the-deployment.md](../../docs/decisions/0006-a-forms-embed-allowlist-belongs-to-the-form-not-to-the-deployment.md).

<a id="a-csp-source-may-no-longer-wildcard-a-public-suffix"></a>
...
<a id="a-forms-embed-allowlist-survives-duplication"></a>
...
<a id="webhook-delivery-now-goes-through-kilncmssafefetch"></a>

- **Webhook delivery now goes through `KilnCMS.SafeFetch`**. The reasoning
  behind it is recorded as a decision in
  [docs/decisions/0008-outbound-fetches-go-through-kilncmssafefetch-which-pins-the-resolved-address.md](../../docs/decisions/0008-outbound-fetches-go-through-kilncmssafefetch-which-pins-the-resolved-address.md).

<a id="mix-kilnauditverify-can-now-fail-a-run-it-previously-passed-and-no-longer-calls"></a>
...
<a id="demoting-offboarding-or-erasing-a-user-now-drops-their-live-sockets"></a>
...
<a id="an-editor-can-no-longer-clear-an-admin-set-block-field-by-omitting-it"></a>
...
<a id="registration-password-reset-and-magic-link-forms-are-bounded-per-client-address"></a>
...
<a id="the-openapi-document-and-swagger-explorer-are-no-longer-served-in-production-by"></a>
...
<a id="a-bracketed-query-parameter-no-longer-500s-a-public-route"></a>
...
<a id="the-two-sign-in-gates-no-longer-carry-their-own-copy-of-the-pending-token"></a>
...
<a id="a-password-that-stops-at-the-code-prompt-no-longer-clears-the-accounts-sign-in"></a>
...
<a id="a-second-factor-lockout-now-tells-the-owner"></a>
...
<a id="the-three-totp-actions-on-editorsettings-are-now-budgeted-so-a-stolen-session"></a>
...
<a id="post-apiauthsignin-no-longer-skips-the-second-factor"></a>
...
<a id="history-anchors-verify-as-a-chain-not-just-at-the-head"></a>

- **History anchors verify as a chain, not just at the head.** The reasoning
  behind it is recorded as a decision in
  [docs/decisions/0003-history-anchors-verify-as-a-chain-and-an-unjudgeable-anchor-floors-the-chain.md](../../docs/decisions/0003-history-anchors-verify-as-a-chain-and-an-unjudgeable-anchor-floors-the-chain.md).

<a id="a-liveview-join-with-no-url-is-refused-instead-of-skipping-every-router-gate"></a>

- **A LiveView join with no URL is refused instead of skipping every router
  gate.** The reasoning behind it is recorded as a decision in
  [docs/decisions/0004-a-liveview-join-that-matches-no-route-is-refused-rather-than-mounted-ungated.md](../../docs/decisions/0004-a-liveview-join-that-matches-no-route-is-refused-rather-than-mounted-ungated.md).

<a id="the-session-cookie-is-host--prefixed-in-production"></a>

- **The session cookie is `__Host-`-prefixed in production.** The reasoning
  behind it is recorded as a decision in
  [docs/decisions/0005-the-production-session-cookie-is-host--prefixed-with-no-dual-read-window.md](../../docs/decisions/0005-the-production-session-cookie-is-host--prefixed-with-no-dual-read-window.md).

<a id="the-shared-token-preview-wears-the-requesting-sites-branding-too"></a>
...
<a id="error-pages-now-wear-the-requesting-sites-branding-not-the-default-orgs"></a>
...
<a id="tenantstricthost-refusals-no-longer-cost-a-database-lookup-every-time"></a>
...
<a id="the-strict-host-404-is-documented-as-the-tenant-name-oracle-it-is"></a>
...
<a id="the-collaborative-editing-socket-now-authorizes-every-join-against-the-document"></a>
...
<a id="history-anchors-chain-to-each-other-by-id-and-digest-narrowing-the-laundering"></a>
...
<a id="a-malformed-trustedproxies-no-longer-takes-the-node-down"></a>
...
<a id="tenantstricthost-is-read-with-configenvfetch1-rather-than-flag2-so-leaving-the"></a>
...
<a id="the-site-header-on-and-developers-now-renders-the-requesting-organizations-logo"></a>
...
<a id="embeddable-forms-no-longer-default-to-frame-ancestors"></a>
...
<a id="a-malformed-embedorigins-now-closes-the-policy-instead-of-widening-it"></a>
...
<a id="an-allowlist-now-keeps-self"></a>
