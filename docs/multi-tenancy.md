...
This page is the isolation model in one place. The configuration table is
*Optional — multi-tenancy (#336)* in [environment-variables.md](environment-variables.md);
...
[`TENANT_STRICT_HOST`](environment-variables.md), in *Optional — multi-tenancy (#336)*.
