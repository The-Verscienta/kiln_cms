...
| Configure | `/editor/configure` | **admin** | the hub: every site- and instance-level settings screen, with a filter |
...
| Billing / System | `/editor/billing`, `/editor/system` | **admin** | membership providers; which version of the software runs here |
