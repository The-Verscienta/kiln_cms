 ...
 * preview tokens, the JSON:API write surface (create, update, workflow
 * transitions, soft-delete) and a minimal `/gql` helper (see Kiln's
...
export class KilnClient {
  ...
  private request(
    ...
    return this.send("GET", path, { params, signal, accept });
  }
